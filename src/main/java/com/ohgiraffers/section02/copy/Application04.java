...
public class Application04 {
    ...
    public static void main(String[] args) {
        ...
        *  */
        ...
        /* 필기.
        *   향상된 for문
        *   배열 인덱스에 하나씩 차례로 접근해서 담긴 값을
        *   임시로 사용할 변수에 담고 반복문을 실행함
        *   */
        ...
        /* 필기.
        *   주의:향상된 for문은 배열의 인덱스에 차례로 접근할 때는 편하게 사용할 수 있지만 값을 변경할 수 없다.
        *       대신, 변경하는 것이 아니고 사용하는 것이 목적이라면 조금 더 편하게 사용할 수 있다.
        *   */

        for(int i : arr2){
            System.out.print(i + " ");      //단순 조회용으로 많이 쓰나 몰라도 상관 없음
        }
